...
The issue of difficulty of replicating results (Issue 7) is not directly addressed by features of OpenTTDLab. However, as mentioned earlier, its documentation encourages authors to address this by including details of the explicit algorithms created when publishing.
