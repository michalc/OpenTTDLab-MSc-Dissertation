...
plot 'notebooks/02_trains_ai_vs_admiral_ai_results_03_openttdlab_company_value_quartiles.csv' \ 
   using (timecolumn(1, '%Y-%m-%d')):2:4 skip 4 with filledcurves lc rgb '#cccccc' title "Admiral Q1 - Q3", \
   '' using (timecolumn(1, '%Y-%m-%d')):3 skip 4 with lines title 'Admiral median', \
   '' using (timecolumn(1, '%Y-%m-%d')):2 skip 4 with lines lc rgb '#cccccc' title '', \
   '' using (timecolumn(1, '%Y-%m-%d')):4 skip 4 with lines lc rgb '#cccccc' title '', \
   '' using (timecolumn(1, '%Y-%m-%d')):5:7 skip 4 with filledcurves lc rgb '#cccccc' title "trAIns Q1 - Q3", \
   '' using (timecolumn(1, '%Y-%m-%d')):6 skip 4 with lines title 'trAIns median', \
   '' using (timecolumn(1, '%Y-%m-%d')):5 skip 4 with lines lc rgb '#cccccc' title '', \
   '' using (timecolumn(1, '%Y-%m-%d')):7 skip 4 with lines lc rgb '#cccccc' title ''
\end{gnuplot}
