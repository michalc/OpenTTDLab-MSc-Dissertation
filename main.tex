...
No transport infrastructure exists on startup other than roads within towns. It is the role of the players, including any AI players, to build these to connect towns and industries in order to earn revenue. On startup each company is provided a loan with which to begin building the infrastructure.
