...
plot 'notebooks/02_own_parameterised_ai_results_02_money_mean_standard_deviation.csv' \ 
   using (timecolumn(1, '%Y-%m-%d')):6 skip 2 with lines title 'Mean for 16 buses' lt 1 lw 3, \
   '' using (timecolumn(1, '%Y-%m-%d')):5 skip 2 with lines title 'Mean for 8 buses' lt 2 lw 3, \
   '' using (timecolumn(1, '%Y-%m-%d')):4 skip 2 with lines title 'Mean for 4 buses' lt 3 lw 3, \
   '' using (timecolumn(1, '%Y-%m-%d')):3 skip 2 with lines title 'Mean for 2 buses' lt 4 lw 3, \
   '' using (timecolumn(1, '%Y-%m-%d')):2 skip 2 with lines title 'Mean for 1 bus' lt 6 lw 3
\end{gnuplot}
...
plot 'notebooks/02_own_parameterised_ai_results_02_money_mean_standard_deviation.csv' \ 
   ...
   '' using (timecolumn(1, '%Y-%m-%d')):2 skip 2 with lines notitle lt 6 lw 3, \
   '' using (timecolumn(1, '%Y-%m-%d')):6 skip 2 with lines notitle lt 1 lw 3, \
   ...
   NaN with lines title 'Mean for 16 buses'  lt 1 lw 3, \
   NaN with filledcurves fs solid lc rgb '#cccccc' title "$\\pm \\textrm{1 std. dev.}$", \
   NaN with lines title 'Mean for 1 bus' lt 6 lw 3
\end{gnuplot}
