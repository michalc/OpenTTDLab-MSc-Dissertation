...
The version of trAIns was 2.1,  the version of AdmiralAI  25. AdmiralAI 25 has a single dependency: Queue.FibonacciHeap, which is pinned to version 2 by AdmiralAI 25 code. None of the versions were specified in the original paper. All the AIs and their dependencies these were all retrieved from BaNaNaS---as discussed in the previous chapter.
