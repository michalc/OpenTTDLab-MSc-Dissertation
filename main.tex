...
Explain what OpenTTD is in more detail, with maybe a screenshot and some history? Summarise the main themes of research using it.
\end{YStkyNote}
...
\begin{YStkyNote}[TODO]
Explain some of the configuration thas is useful for reproducibility
\end{YStkyNote}
