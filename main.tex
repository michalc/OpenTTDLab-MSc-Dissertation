...
mylabel(name,terrain,source) = sprintf("%s, %s, %s", name, terrain, source)

plot 'notebooks/02_trains_ai_vs_admiral_ai_results_01_combined_final.csv' \ 
   using (1):3:(0.3):(mylabel(stringcolumn(2),stringcolumn(4),stringcolumn(6))) title 'This'
\end{gnuplot}
