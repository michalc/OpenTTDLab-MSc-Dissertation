...
Choosing what I believe to be a reasonable authoritative source, I primarily use the ACM definitions \emph{Artifact Review and Badging Version 1.1} \cite{association_for_computing_machiner_artifact_2020}, after this swap. The definition is given in terms of artifacts:
...
In spite of the historical confusion and vagueness of even the most recent definitions of the 3Rs, there are a number of relevant recommendations that in general can be followed.
