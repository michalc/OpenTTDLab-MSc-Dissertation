...
\section{Simple parameterised AI}

I constructed a simple parameterised AI that created a single route

\begin{algorithm}
\caption{Simple parameterised AI}\label{alg:three}
\KwData{The number of buses to build in the AI N}
 Fetch list of towns \;
 Choose 2 biggest \;
 Build route between them \;
