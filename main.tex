...
The setup was as close as possible as to what was described as the setup in \cite{rios2009trains}. In all cases the map was configured to be 512x512 tiles, with a very low amount of seas, vehicle breakdowns were disabled and the starting year set to 1960.

However, it was not possible to completely recreate the setup in several ways. The version of OpenTTD was given as 16724 - referring to a revision number in what was OpenTTD's SVN setup. However, OpenTTDLab does not currently support this version because of the older format of savegame files it outputs. Instead, I used OpenTTD version 13.4. This also resulted

Also the version of trAIns was not specified, nor the version of Admiral AI, nor the version of what is currently its singular dependency. Finally, the original experiments were not conducted for the exact same amount of in game time: varying from 15 years and 2 days to 15 years and 11 months. The results presented here are for exactly 15 years of in-game time.
