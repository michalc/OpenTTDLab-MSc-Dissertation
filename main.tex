...
\item[keep\_all\_autosave]
\item[autosave\_on\_exit] 
\item[max\_num\_autosaves] A number of autosave related settings allow the player to automatically save OpenTTD in a custom binary format regularly while the game runs.
